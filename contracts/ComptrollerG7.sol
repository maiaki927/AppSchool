...
contract ComptrollerG7 is ComptrollerV5Storage, ComptrollerInterface, ComptrollerErrorReporter, ExponentialNoError {
    ...
    function getAccountLiquidityInternal(address account) internal view returns (Error, uint, uint) {
        // console.log("account, CToken(address(0)), 0, 0",account, CToken(address(0)), 0, 0);
    ...
    function getHypotheticalAccountLiquidityInternal(
        ...
        if (vars.sumCollateral > vars.sumBorrowPlusEffects) {
            //  console.log("3--------ars.sumCollateral > vars.sumBorrowPlusEffects",vars.sumCollateral , vars.sumBorrowPlusEffects);
